                    ...
                    <>
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex justify-end">
                                <Link href={`/offers?q=productId:'${router.query.productId}' ${data.data.options.map(({ option }) => `option${option}:'${data.data[`option${option}` as keyof typeof data.data]}'`).join(" ")}`} className="flex space-x-2 hover:bg-gray-300 p-2 text-gray-700 font-medium rounded-md">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
