...
export default function MediaCard({ src, alt }: IProps) {
    ...
    return (
        <div className="relative w-full aspect-square flex justify-end group">
            <div className="flex flex-col z-20 space-y-1 p-2 invisible group-hover:visible">
                <button className="" onClick={ onPopupOpen }>
            ...
            <div className="absolute inset-0 bg-black z-10 bg-opacity-0 hover:bg-opacity-10 cursor-grab">
            </div>
