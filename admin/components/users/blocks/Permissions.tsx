...
export default function Permissions({ onChange, permissions }: IProps) {
    ...
    useEffect(() => {
        const isChanged = initialState.sort().join() !== state.sort().join()

        onChange({ permissions: isChanged === true ? state : undefined })
    }, [state])
            ...
            <div className="p-5 grid grid-cols-2 gap-8">
                <div className="">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="ORDER_CREATE" name="ORDER_CREATE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "ORDER_CREATE") } onChange={ onInputChange } />
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="ORDER_DELETE" name="ORDER_DELETE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "ORDER_DELETE") } onChange={ onInputChange } />
                ...
                <div className="">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="PRODUCT_CREATE" name="PRODUCT_CREATE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "PRODUCT_CREATE") } onChange={ onInputChange } />
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="PRODUCT_DELETE" name="PRODUCT_DELETE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "PRODUCT_DELETE") } onChange={ onInputChange } />
                ...
                <div className="">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="OFFER_CREATE" name="OFFER_CREATE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "OFFER_CREATE") } onChange={ onInputChange } />
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="OFFER_DELETE" name="OFFER_DELETE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "OFFER_DELETE") } onChange={ onInputChange } />
                ...
                <div className="">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="COLLECTION_CREATE" name="COLLECTION_CREATE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "COLLECTION_CREATE") } onChange={ onInputChange } />
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="COLLECTION_DELETE" name="COLLECTION_DELETE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "COLLECTION_DELETE") } onChange={ onInputChange } />
                ...
                <div className="">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="USER_CREATE" name="USER_CREATE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "USER_CREATE") } onChange={ onInputChange } />
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="USER_DELETE" name="USER_DELETE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "USER_DELETE") } onChange={ onInputChange } />
                ...
                <div className="">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="SHIPPING_CREATE" name="SHIPPING_CREATE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "SHIPPING_CREATE") } onChange={ onInputChange } />
                        ...
                        <div className="flex items-center">
                            <input type="checkbox" id="SHIPPING_DELETE" name="SHIPPING_DELETE" className="w-5 h-5 rounded-md" checked={ state.some(c => c === "SHIPPING_DELETE") } onChange={ onInputChange } />
