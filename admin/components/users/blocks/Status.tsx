        ...
        <div className="rounded-md bg-white shadow-sm">
            ...
            <div className="p-5 space-y-4">
                <div className="">
                    ...
                    <Select
                        options={{
                            true: { value: "Подтвержден", disabled: false },
                            false: { value: "Не подтвержден", disabled: false }
                        }}
                        name="isVerified"
                        value={state.isVerified.toString()}
                ...
                <div className="">
                    ...
                    <Select
                        options={{
                            true: { value: "Подписан", disabled: false },
                            false: { value: "Не подписан", disabled: false }
                        }}
                        name="isSubscribed"
