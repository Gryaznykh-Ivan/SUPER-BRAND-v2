...
export default function Media({ collectionId, images }: IProps) {
    ...
    const [uploadImages, { isSuccess: isUploadImagesSuccess, isLoading: isUploadImagesLoading, isError: isUploadImagesError, error: uploadImageError }] = useUploadCollectionImagesMutation()
