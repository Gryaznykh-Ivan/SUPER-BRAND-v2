...
import { useRemoveImageMutation, useUpdateImageMutation, useUploadImagesMutation } from '../../../services/productService';
...
export default function Media({ productId, images }: IProps) {
    ...
    const [uploadImages, { isSuccess: isUploadImagesSuccess, isError: isUploadImagesError, error: uploadImageError }] = useUploadImagesMutation()
    const [updateImage, { isSuccess: isUpdateImageSuccess, isError: isUpdateImageError, error: updateImageError }] = useUpdateImageMutation()
    const [removeImage, { isSuccess: isRemoveImageSuccess, isError: isRemoveImageError, error: removeImageError }] = useRemoveImageMutation()
