...
interface IProps {
    ...
    item: IProductOption;
    index: number;
    onOptionValuesUpdate: (id: string, data: Pick<ProductUpdateOptionRequest, "createOptionValues" | "deleteOptionValues" | "updateOptionValues">) => void;
                    ...
                    <div className="pb-2">
                        {state.values.map(value =>
                            <div key={value.id} className="flex items-center justify-between pr-2 bg-white">
                                <Input type="text" placeholder="option1" name={value.id} value={value.title} onChange={onOptionValueChange} />
