...
export default function VariantList({ isAddNew=false }: IProps) {
    return (
        <div className="rounded-md bg-white shadow-sm">
            <h2 className="font-semibold p-5 border-b-[1px]">Варианты</h2>
            <div className="border-b-[1px] divide-y-[1px] h-[408px] overflow-auto">
                <Link href="/products/example/variants/example" className="flex justify-between px-5 py-3 hover:bg-gray-200">
                    <span className="font-medium">US 4</span>
                    <div className="text-end text-gray-500">
                        <div className="">от 45.000</div>
                        <div className="text-sm">35.000</div>
                    </div>
                </Link>
                <Link href="/products/example/variants/example" className="flex justify-between px-5 py-3 hover:bg-gray-200">
                    <span className="font-medium">US 4.5</span>
                    <div className="text-end text-gray-500">
                        <div className="">от 45.000</div>
                        <div className="text-sm">35.000</div>
                    </div>
                ...
                <Link href="/products/example/variants/example" className="flex justify-between px-5 py-3 hover:bg-gray-200">
                    <span className="font-medium">US 5</span>
                    <div className="text-end text-gray-500">
                        <div className="">Пусто</div>
                        <div className="text-sm">35.000</div>
                    </div>
                </Link>
                <Link href="/products/example/variants/example" className="flex justify-between px-5 py-3 hover:bg-gray-200">
                    <span className="font-medium">US 6</span>
                    <div className="text-end text-gray-500">
                        <div className="">Пусто</div>
                        <div className="text-sm">35.000</div>
                    </div>
