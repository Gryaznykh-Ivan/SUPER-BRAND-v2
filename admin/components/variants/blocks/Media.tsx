...
export default function Media({ variantId, images }: IProps) {
    ...
    const [uploadImages, { isSuccess: isUploadImagesSuccess, isLoading: isUploadImagesLoading, isError: isUploadImagesError, error: uploadImageError }] = useUploadVariantImagesMutation()
