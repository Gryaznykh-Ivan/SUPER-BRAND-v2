...
export default function Index() {
    ...
    const getDurationSinceLastUpdate = (updatedAt: string) => {
        ...
        return (`${diffDays > 0 ? diffDays + "д" : ""} ${diffHours > 0 ? diffHours + "ч" : ""} ${diffHours === 0 && diffDays === 0 && diffMinutes + "м"} назад`).trim()
    }
        ...
        <MainLayout>
            ...
            <div className="px-6 my-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="">
                        <button className="block bg-green-700 px-4 py-2 text-white font-medium rounded-md">В очередь</button>
                    </div>
                </div>
