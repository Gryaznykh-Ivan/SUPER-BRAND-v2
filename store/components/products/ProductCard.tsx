...
export default function ProductCard({ title, vendor, type, price, compareAtPrice }: IProps) {
    return (
        <Link href="/products/example" className="group">
            <div className="relative aspect-5/3">
                <Image
                    ...
                    alt="TEST"
                />
                <div className="absolute top-0 right-0 transition-opacity opacity-0 group-hover:opacity-100" onClick={e => e.preventDefault()}>
