    ...
    return (
        <div className="pt-8 flex flex-col gap-8 lg:flex-row md:p-16">
            <div className="">
                ...
                <div className="text-md tracking-widest mt-4">Подпишитесь и получите эксклюзивный ранний доступ к скидкам и новым поступлениям</div>
            </div>
            <div className="">
                <div className="text-md tracking-widest font-medium uppercase mb-2">адрес электронной почты</div>
